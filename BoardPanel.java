...
public class BoardPanel extends JPanel {
     ...
     * tetris The Tetris instance to use.
     */
    ...
    public boolean isValidAndEmpty(TileType type, int x, int y, int rotation) {
         ...
         *
         * It's fine to do this even though it allows for wrapping because we've already
    ...
    /**
     * Adds a piece to the game board. Doesn't check for existing pieces,
